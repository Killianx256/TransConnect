...
{///Méthode pour créer les clients
...

    {
        ...
        ///Méthode pour ajouter à la database les commandes des clients
        ...
        ///Méthode pour créer un client dans la database
        ...
        ///Méthode pour charger les commandes des clients. De cette manière, les mises à jour sont dynamiques et sont
        ...
        ///Méthode pour ajouter une commande au client
        public void AjouterCommande(Commande commandeAAjouter)
        {
            commande.Add(commandeAAjouter.NCom);
        }

        ///Méthode pour supprimer une commande dans la database
        ...
        /// Méthode pour supprimer un client de la database 
