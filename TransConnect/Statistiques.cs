...
namespace FOURNIER_LOPES
{
    ...
    {
        ///Méthode pour afficher les livraisons par chauffeurs (soit tous soit pour un chauffeur spécifique)
        ...
        /// Le délégué LivraisonFiltre définit une méthode qui prend une Livraison en paramètre et retourne un booléen 
        /// pour déterminer si cette livraison satisfait une condition spécifique.
        public delegate bool LivraisonFiltre(Livraison livraison);

        ///méthode pour afficher les livraisons filtrées par une condition spécifiée, en incluant les détails du chauffeur et de la livraison.
        ...
        ///Méthode pour afficher le prix moyen des livraisons
        ...
        ///Méthode pour afficher les commandes d'un client sélectionner
        ...
        ///Méthode pour afficher la moyenne des comptes (commandes) des clients
