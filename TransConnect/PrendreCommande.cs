...
namespace FOURNIER_LOPES
{
    public class PrendreCommande
    {
        ...
        /// Methode qui permet de créer totalement une commande avec ses dépendances : ( Dispo chauffeurs , vehicules / Livraison )
        ...
        /// Methode qui permet de gérer la disponibilité des Chauffeurs et Vehicules sans conflit entre les deux
        ...
        /// Créer un graphe pour la methode Dijkstra depuis le fichier distances.txt
        ...
        /// Calcul le prix d'une commande en fonction de la commande , du client et du chauffeur
        ...
        /// Converti le temps du fichier distance.txt en double
